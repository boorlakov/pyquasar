...
class HyperbolicProblem(FemProblem):
  ...
  def add_init_conds(self, condition: callable = None, velocity: callable = None) -> None:
  ...
  def solve(
    ...
    for time_stamp in range(2, self.time_mesh.time_stamps):
      print(time_stamp)
